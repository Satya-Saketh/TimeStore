                ...
                <div className={classes.headerContainer}>
                    ...
                    <div className={classes.themeButtonsContainer}>
                        {["grey", "blue", "purple"].map((c) => (
                            ...
                            <button key={c} className={`${classes.themeButton(activeColor === c)} ${themeButtonColors[c]}`}
                ...
                <div className={classes.gridContainer}>
                    <form onSubmit={handleSubmit} className={classes.formContainer(theme)}>
                        ...
                        <div>
                            ...
                            <input value={name} onChange={(e) => setName(e.target.value)} placeholder="e.g. Classic Silver" className={inputClass}
                        ...
                        <div>
                            ...
                            <textarea value={description} onChange={(e) => setDescription(e.target.value)} rows={4}
                                placeholder="short Description about watch" className={`${inputClass} resize-none`} required disabled={loading}>
