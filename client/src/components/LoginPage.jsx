                    ...
                    <form onSubmit={handleSubmit}>
                        <div className={loginPageStyles.formField}>
                            ...
                            <div className={loginPageStyles.inputContainer}>
                                ...
                                <input type="email" id="email" className={loginPageStyles.inputBase} placeholder="Enter your email"
                        ...
                        <div className={loginPageStyles.formField}>
                            ...
                            <div className={loginPageStyles.inputContainer}>
                                ...
                                <input type={showPassword ? "text" : "password"} id="password" className={loginPageStyles.passwordInputBase} placeholder="Enter your password"
                                    value={password} onChange={(e) => setPassword(e.target.value)} required disabled={submitting} />
                                <button type="button" className={loginPageStyles.passwordToggle} onClick={() => setShowPassword(!showPassword)} disabled={submitting}>
                        ...
                        <div className={loginPageStyles.rememberMeContainer}>
                            <div className={loginPageStyles.checkboxContainer}>
                                <input type="checkbox" id="rememberMe" className={loginPageStyles.checkbox} checked={rememberMe}
                                    onChange={() => setRememberMe(!rememberMe)} required disabled={submitting} />
                            </div>
                            <div className={loginPageStyles.checkboxLabelContainer}>
                                <label htmlFor='rememberMe' className={loginPageStyles.checkboxLabel}>
                                    Remember Me {" "}
                                    <span className={loginPageStyles.rememberStar}>*</span>
                                </label>
                            </div>
                        </div>

                        <button type="submit" className={`${loginPageStyles.submitButton} ${submitting ? loginPageStyles.submitButtonDisabled : ""
                            }`} disabled={submitting}>
