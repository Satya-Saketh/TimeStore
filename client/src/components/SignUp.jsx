                    ...
                    <form onSubmit={handleSubmit} className={signUpStyles.form}>
                        ...
                        <div className={signUpStyles.inputContainer}>
                            ...
                            <input type="text" value={name} onChange={(e) => setName(e.target.value)}
                                placeholder="Enter Full Name" className={signUpStyles.inputField} required disabled={submitting}/>
                        </div>
                        ...
                        <div className={signUpStyles.inputContainer}>
                            ...
                            <input type="email" value={email} onChange={(e) => setEmail(e.target.value)}
                                placeholder="Enter Email" className={signUpStyles.inputField} required disabled={submitting}/>
                        </div>
                        <div>
                            ...
                            <div className={signUpStyles.inputContainer}>
                                ...
                                <input type={showPassword ? "text" : "password"} value={password} onChange={(e) => setPassword(e.target.value)}
                                    placeholder="Create a password" className={signUpStyles.inputField} required disabled={submitting}/>
                        ...
                        <div className={signUpStyles.checkboxContainer}>
                            <label className={signUpStyles.checkboxLabel}>
                                <input type="checkbox" checked={rememberMe} onChange={() => setRememberMe(!rememberMe)} required
                                    className={signUpStyles.checkboxInput} disabled={submitting}/>
                        ...
                        <button type='submit' className={`${signUpStyles.submitButton} ${submitting ? signUpStyles.submitButtonDisabled : ""}`} disabled={submitting}>
                            {submitting ? "Creating Account" : "Sign"}
                        </button>
                    </form>
                    <div className={signUpStyles.bottomContainer}>
                        <span className={signUpStyles.bottomText}>Already have an account?{" "}</span>
