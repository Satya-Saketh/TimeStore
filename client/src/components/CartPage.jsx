                    ...
                    <div className={cartPageStyles.headerContainer}>
                        <div className={cartPageStyles.backButtonContainer}>
                            <Link to='/watches' className={cartPageStyles.backLink}>
                                ...
                                <span className={cartPageStyles.backText}>
                                    Back to watches
                                </span>
                            </Link>
                        </div>
                    ...
                    <div className={cartPageStyles.mainGrid}>
                        <div className={cartPageStyles.leftColumn}>
                            <div className={cartPageStyles.formContainer}>
                                <h2 className={cartPageStyles.formTitle}>
                                    Enter your details
                                </h2>
                                ...
                                <form onSubmit={handleSubmit} className={cartPageStyles.form}>
                                    <div className={cartPageStyles.inputGrid}>
                                        <input type="text" value={name} onChange={(e) => setName(e.target.value)}
                                            placeholder="Full Name" className={cartPageStyles.inputBase} required />
                                        <input type="email" value={email} onChange={(e) => setEmail(e.target.value)}
                                            placeholder="Email Address" className={cartPageStyles.inputBase} required />

                                    </div>
                                    <input type="text" value={mobile} onChange={handleMobileChange}
                                        placeholder="Mobile Number" className={cartPageStyles.inputBase} required />
                                    ...
                                    <div className={cartPageStyles.formButtonsContainer}>
                                        <button type="submit" className={cartPageStyles.submitButton} disabled={submitting}>
