...
const Footer = () => {
    return (
        <footer className={footerStyles.footer}>
            ...
            <div className={footerStyles.mainContainer}>
                ...
                <div className={footerStyles.mainGrid}>
                    <div className={footerStyles.brandSection}>
                        <div className={footerStyles.brandContainer}>
                            ...
                            <span className={footerStyles.brandName}>TimeStore</span>
                ...
                <div className={footerStyles.bottomSection}>
                    <p className={footerStyles.copyright}>
                        &copy; {new Date().getFullYear()} TimeStore. Crafted with{" "}
                        <Heart className={footerStyles.heartIcon}/> in India
                    </p>
                    <div className='flex flex-wrap justify-center gap-2'>
                        <p className={footerStyles.designerLink}>
                            Designed by{" "}
                            <a href="#" target="_blank" rel="noopener noreferrer" className={footerStyles.linkHover}>
                                Satya Saketh
                            </a>
                        </p>
                    </div>
            ...
            <style className={footerStyles.mediaQueries}></style>
